    ...
    createExchange: function (_, _a, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, exchange_model_1["default"].create(__assign({}, exchange))];
...
exports.ExchangeQueries = {
    exchanges: function (_) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, exchange_model_1["default"].find({})];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    },
    exchange: function (_, _a) {
        var id = _a.id;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, exchange_model_1["default"].findById(id)];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        });
